//##########################################################################
//#                                                                        #
//#                CLOUDCOMPARE PLUGIN: SubSampleTools                      #
//#                                                                        #
...
//! Example qCC plugin
/** Replace 'SubSampleTools' by your own plugin class name throughout and then
	check 'SubSampleTools.cpp' for more directions.
...
**/
class SubSampleTools : public QObject, public ccStdPluginInterface
{
    Q_OBJECT
	...
	Q_PLUGIN_METADATA(IID "cccorp.cloudcompare.plugin.SubSampleTools" FILE "../info.json")

public:
    explicit SubSampleTools(QObject *parent = nullptr);
    ~SubSampleTools() override = default;
