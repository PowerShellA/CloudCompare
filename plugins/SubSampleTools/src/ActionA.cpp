...
namespace Example
{
    ...
    void performActionA(ccMainAppInterface *appInterface)
    {
        ...
        appInterface->dispToConsole("[SubSampleTools] Hello world!", ccMainAppInterface::STD_CONSOLE_MESSAGE);

        // Display a warning message in the console
        appInterface->dispToConsole("[SubSampleTools] Warning: example plugin shouldn't be used as is", ccMainAppInterface::WRN_CONSOLE_MESSAGE);
