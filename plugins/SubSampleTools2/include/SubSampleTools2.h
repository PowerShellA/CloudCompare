//##########################################################################
//#                                                                        #
//#                CLOUDCOMPARE PLUGIN: SubSampleTools2                      #
//#                                                                        #
...
//! Example qCC plugin
/** Replace 'SubSampleTools2' by your own plugin class name throughout and then
	check 'SubSampleTools2.cpp' for more directions.
...
**/
class SubSampleTools2 : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
	...
	Q_PLUGIN_METADATA( IID "cccorp.cloudcompare.plugin.SubSampleTools2" FILE "../info.json" )

public:
	explicit SubSampleTools2( QObject *parent = nullptr );
	~SubSampleTools2() override = default;
